...
const getData = async () => {
    ...
    try {
        ...
        let res = await fetch(`https://newsapi.org/v2/top-headlines?country=us&apiKey=368d5c72177441deb75ef482bdaa8817`)
...
const photo = async () => {
    ...
    try {
        let res = await fetch(`
        https://newsapi.org/v2/top-headlines?country=il&apiKey=368d5c72177441deb75ef482bdaa8817`);
