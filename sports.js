...
const getData = async () => {
    ...
    try {
        ...
        let res = await fetch(`https://newsapi.org/v2/top-headlines?country=us&apiKey=8950f831476a4721992122f92b9a9ccb`)
...
const cricket = async () => {
    try {
        let res = await fetch(`https://newsapi.org/v2/top-headlines?country=gb&category=sports&apiKey=8950f831476a4721992122f92b9a9ccb`);
        let data = await res.json();
...
const photo = async () => {
    ...
    try {
        let res = await fetch(`
        https://newsapi.org/v2/top-headlines?country=il&apiKey=8950f831476a4721992122f92b9a9ccb`);
