...
const india = async () => {
    try {
        let res = await fetch(`https://newsapi.org/v2/everything?q=apple&from=2022-09-29&to=2022-09-29&sortBy=popularity&apiKey=368d5c72177441deb75ef482bdaa8817`);
        let data = await res.json();
...
const photo = async () => {
    ...
    try {
        let res = await fetch(`
        https://newsapi.org/v2/everything?q=tesla&from=2022-08-30&sortBy=publishedAt&apiKey=368d5c72177441deb75ef482bdaa8817`);
