...
//backup key=  `b0599e59600b4c129dd569247aca6d0b`;
...
async function BusinessNews(){
    ...
    try{
        ...
        let res= await fetch(`https://newsapi.org/v2/top-headlines?country=in&language=en&category=business&apiKey=${key}`);
...
async function news2(){
    ...
    try{
        ...
        let res = await fetch(`https://newsapi.org/v2/top-headlines?country=us&language=en&category=business&apiKey=${key}`)
...
async function viral_news(){
    ...
    try{
        ...
        let res = await fetch(`https://newsapi.org/v2/top-headlines?language=en&category=business&apiKey=${key}`)
