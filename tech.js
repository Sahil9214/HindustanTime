...
async function tech(){
   ...
   try{
       ...
       let res= await fetch(`https://newsapi.org/v2/top-headlines?language=en&category=technology&apiKey=${key}`);
...
async function news2(){
   ...
   try{
       ...
       let res = await fetch(`https://newsapi.org/v2/top-headlines?country=in&language=en&category=technology&apiKey=${key}`)
...
async function viral_news(){
   ...
   try{
       ...
       let res = await fetch(`https://newsapi.org/v2/top-headlines?language=en&category=technology&country=us&apiKey=${key}`)
